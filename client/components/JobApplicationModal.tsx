...
export default function JobApplicationModal({
  ...
  const handleSubmit = async () => {
    ...
    const existingAgenda = JSON.parse(
      localStorage.getItem("agendaItems") || "[]",
    );
  ...
  const isStep2Valid =
    applicationData.estimatedHours && applicationData.acceptTerms;
        ...
        {!isSubmitted ? (
          <div className="space-y-6">
            ...
            <Card className="glass border border-premium-600/30">
              <CardContent className="p-4">
                <h3 className="text-lg font-semibold text-premium-50 mb-3">
                  {job.title}
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-sm">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-premium-200">
                      {job.budget.currency}
                      {job.budget.min.toLocaleString()} - {job.budget.currency}
              ...
              <div className="space-y-6">
                <div className="space-y-4">
                  <div>
                    <Label
                      htmlFor="message"
                      className="text-premium-200 text-base font-medium"
                    >
                      Persoonlijk bericht *
                    </Label>
                    <Textarea
                  ...
                  <div>
                    <Label htmlFor="materials" className="text-premium-200">
                ...
                <div className="flex gap-3 pt-4">
                  ...
                  <Button
                    onClick={() => {
                      console.log(
                        "Volgende button clicked, step 1 valid:",
                        isStep1Valid,
                      );
                ...
                {!isStep1Valid && (
                  <div className="text-center mt-4">
                    ...
                    <ul className="text-premium-400 text-xs space-y-1">
                      {applicationData.message.length < 10 && (
                        <li>
                          • Persoonlijk bericht (minimaal 10 karakters - nu:{" "}
                          {applicationData.message.length})
                        </li>
                      )}
                      {!applicationData.proposedBudget && (
              ...
              <div className="space-y-6">
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <Label htmlFor="warranty" className="text-premium-200">
                        Garantie (maanden)
                      </Label>
                      <Input
                        id="warranty"
                    ...
                    <CardContent className="space-y-3">
                      ...
                      <div className="border-t border-premium-600 pt-2">
                        <div className="flex justify-between text-lg">
                          <span className="text-premium-50 font-semibold">
                            Jouw netto ontvangst:
                          </span>
                      ...
                      <div className="bg-klusdirect-blue/10 border border-klusdirect-blue/20 rounded-lg p-3 mt-4">
                        <p className="text-klusdirect-blue text-sm">
                          💡 Upgrade naar Professional (€50/mnd) voor 7.5%
                          commissie of Elite (€100/mnd) voor 5% commissie
                        </p>
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <div className="space-y-4 pt-4 border-t border-premium-600/30">
                    <div className="flex items-start space-x-3">
                      ...
                      >
                        ...
                        en bevestig dat alle informatie correct is. Bij
                        acceptatie door de klant wordt de commissie automatisch
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-premium-300 text-sm">
                            Na acceptatie door de klant wordt je offerte
                            bindend. Een factuur wordt automatisch gegenereerd
                            en je commissie wordt ingehouden bij betaling door
                            de klant.
                          </p>
                        </div>
                      </div>
          ...
          <div className="py-8 text-center">
            ...
            <div className="bg-premium-700/50 rounded-lg p-4 mb-6">
              ...
              <p className="text-premium-300 text-sm">
                Een concept-factuur is aangemaakt en staat klaar voor wanneer de
                klant je selecteert. Je kunt de status volgen in je dashboard
                onder "Actieve offertes".
              </p>
            </div>
          </div>
        )}
