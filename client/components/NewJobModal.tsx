...
export default function NewJobModal({ children }: NewJobModalProps) {
  ...
  const handleSubmit = async () => {
    ...
    const newJob = {
      ...
      quotesReceived: 0,
      views: 0,
      location: jobData.useBusinessAddress
        ? customerInfo.businessAddress
        : `${jobData.jobAddress}, ${jobData.jobPostalCode} ${jobData.jobCity}`,
    };
    ...
    const publicJob = {
      ...
      urgency:
        newJob.urgency === "premium"
          ? "Premium"
          : newJob.urgency === "urgent"
            ? "Urgent"
            : "Normal",
  ...
  const isStep2Valid =
    jobData.budgetMin && jobData.budgetMax && jobData.startDate;
        ...
        {!isSuccess ? (
              ...
              <div className="space-y-6">
                <div className="text-center">
                  ...
                  <p className="text-premium-300">
                    Geef een duidelijke beschrijving zodat vakmensen de juiste
                    offerte kunnen maken
                  </p>
                </div>

                <div className="space-y-4">
                  <div>
                    <Label htmlFor="title" className="text-premium-200">
                      Titel van de klus *
                    </Label>
                    <Input
                      id="title"
                  ...
                  <div>
                    <Label className="text-premium-200 mb-3 block">
                      Categorie *
                    </Label>
                      ...
                      {categories.map((category) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <span className="text-xs text-premium-200">
                              {category.name}
                            </span>
                          </button>
                        );
                  ...
                  <div>
                    <Label htmlFor="description" className="text-premium-200">
                      ...
                      <div className="space-y-2">
                        <label className="flex items-center space-x-3 cursor-pointer p-3 rounded-lg border border-premium-600/30 hover:border-premium-500/50">
                          <RadioGroupItem
                            value="normal"
                            id="normal"
                            className="border-premium-600 text-klusdirect-orange"
                          />
                          <div>
                        ...
                        <label className="flex items-center space-x-3 cursor-pointer p-3 rounded-lg border border-premium-600/30 hover:border-premium-500/50">
                          ...
                          <div>
                            ...
                            <p className="text-premium-400 text-sm">
                              Binnen 1 week starten - meer aandacht
                            </p>
                          </div>
                        </label>
                        <label className="flex items-center space-x-3 cursor-pointer p-3 rounded-lg border border-premium-600/30 hover:border-premium-500/50">
                          ...
                          <div className="flex items-center">
                            <div>
                              ...
                              <p className="text-premium-400 text-sm">
                                Hoogste prioriteit - alleen top vakmensen
                              </p>
                            </div>
            ...
            {step === 2 && !isSubmitting && (
              <div className="space-y-6">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <Label className="text-premium-200 mb-3 block">
                      Waar moet de klus uitgevoerd worden?
                    </Label>
                      ...
                      <label className="flex items-center space-x-3 cursor-pointer">
                        <Checkbox
                          ...
                          onCheckedChange={(checked) =>
                            handleInputChange("useBusinessAddress", checked)
                          }
                        ...
                        <span className="text-premium-200">
                          Op mijn bedrijfsadres ({customerInfo.businessAddress})
                        </span>
                      </label>
                          ...
                          <div className="grid grid-cols-2 gap-3">
                            ...
                            <div>
                              ...
                              <Input
                                ...
                                onChange={(e) =>
                                  handleInputChange("jobCity", e.target.value)
                                }
                                className="glass border-premium-600/30 bg-premium-800/50 text-premium-50 mt-1"
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-3 mb-3">
                      <div>
                        <Label
                          htmlFor="budgetMin"
                          className="text-premium-300 text-sm"
                        >
                          Minimum budget (€)
                        </Label>
                        <Input
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <Label htmlFor="startDate" className="text-premium-200">
                        Gewenste startdatum *
                      </Label>
                      <Input
                        id="startDate"
            ...
            {step === 3 && !isSubmitting && (
              <div className="space-y-6">
                <div className="text-center">
                  ...
                  <p className="text-premium-300">
                    Voeg foto's toe voor betere offertes en stel uw voorkeuren
                    in
                  </p>
                </div>
                ...
                <div className="space-y-6">
                  {/* Images */}
                  <div>
                    <Label className="text-premium-200 mb-2 block">
                      Foto's van de situatie (optioneel)
                    </Label>
                    ...
                    <p className="text-xs text-premium-400">
                      Maximaal 6 foto's, 5MB per foto
                    </p>
                  </div>
                  ...
                  <div className="space-y-4 pt-4 border-t border-premium-600/30">
                    <div className="flex items-start space-x-3">
                      ...
                      <Label
                        htmlFor="acceptTerms"
                        className="text-premium-200 text-sm cursor-pointer"
                      >
                        Ik ga akkoord met de{" "}
                        <span className="text-klusdirect-gold hover:underline">
                          algemene voorwaarden
                        </span>{" "}
                        en geef toestemming voor het delen van mijn
                        contactgegevens met geïnteresseerde vakmensen.
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <Label
                        ...
                        className="text-premium-200 text-sm cursor-pointer"
                      >
                        Ik wil updates ontvangen over de status van mijn klus en
          ...
          <div className="py-8 text-center">
            ...
            <p className="text-premium-200 mb-6 text-lg">
              Uw klus is nu zichtbaar voor vakmensen. U ontvangt binnen 24 uur
              de eerste offertes.
            </p>

            <div className="bg-premium-700/50 rounded-lg p-6 mb-6 text-left max-w-md mx-auto">
              <h4 className="text-premium-50 font-medium mb-4 text-center">
                Wat gebeurt er nu?
              </h4>
              <div className="space-y-3 text-sm">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-premium-200">
                    U ontvangt offertes via de app
                  </span>
                </div>
                <div className="flex items-center">
                  <div className="w-6 h-6 bg-klusdirect-orange rounded-full flex items-center justify-center mr-3">
