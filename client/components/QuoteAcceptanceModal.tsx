...
export default function QuoteAcceptanceModal({
  ...
  const calculateInstallments = () => {
    ...
    const lastInstallment =
      quote.proposedAmount - amountPerInstallment * (installments - 1);
  ...
  const handleAccept = async () => {
    ...
    const acceptedQuotes = JSON.parse(
      localStorage.getItem("acceptedQuotes") || "[]",
    );
  ...
  const isStep1Valid =
    acceptanceData.paymentMethod &&
    acceptanceData.paymentSchedule &&
    acceptanceData.acceptTerms;
  const isStep2Valid =
    acceptanceData.preferredStartDate && acceptanceData.acceptDataProcessing;
        ...
        {!isSuccess ? (
            ...
            {showPayment && isProcessing && (
              <div className="space-y-6">
                <div className="text-center">
                  ...
                  <p className="text-premium-300 mb-6">{currentPaymentStep}</p>
              ...
              <div className="space-y-6">
                <div className="text-center">
                  ...
                  <p className="text-premium-300">
                    Selecteer hoe u wilt betalen en of u het bedrag in delen
                    wilt spreiden
                  </p>
                </div>
                ...
                {/* Payment Method */}
                <div>
                  <Label className="text-premium-200 text-lg mb-4 block">
                    Betaalmethode
                  </Label>
                  <RadioGroup
                      ...
                      <CardContent className="p-4">
                        <div className="flex items-center space-x-3">
                          ...
                          <div className="flex items-center space-x-3 flex-1">
                            <CreditCard className="w-8 h-8 text-klusdirect-blue" />
                            <div>
                              <h4 className="text-premium-50 font-medium">
                                Via KlusDirect App
                              </h4>
                              <p className="text-premium-400 text-sm">
                                Veilig betalen via iDEAL, creditcard of
                                bankoverschrijving
                              </p>
                            </div>
                          </div>
                      ...
                      <CardContent className="p-4">
                        <div className="flex items-center space-x-3">
                          ...
                          <div className="flex items-center space-x-3 flex-1">
                            ...
                            <div>
                              <h4 className="text-premium-50 font-medium">
                                Contant / Pin ter plaatse
                              </h4>
                              <p className="text-premium-400 text-sm">
                                Direct betalen aan de vakman bij oplevering
                              </p>
                            </div>
                          </div>
                          <div className="flex items-center text-premium-400">
                      ...
                      <CardContent className="p-4">
                        <div className="flex items-center space-x-3">
                          <RadioGroupItem
                            value="full"
                            id="full"
                            className="border-premium-600 text-klusdirect-gold"
                          />
                          <div className="flex items-center space-x-3 flex-1">
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          <div className="flex items-center space-x-3 flex-1">
                            ...
                            <div>
                              ...
                              <p className="text-premium-400 text-sm">
                                Verdeel de betaling over meerdere maanden
                              </p>
                            </div>
                          </div>
                        </div>
                        ...
                        {acceptanceData.paymentSchedule === "installments" && (
                          <div className="mt-4 pt-4 border-t border-premium-600/30">
                            ...
                            <RadioGroup
                              ...
                              onValueChange={(value) =>
                                handleInputChange("installmentPlan", value)
                              }
                              className="grid grid-cols-3 gap-3"
                            >
                              {["2", "3", "4"].map((months) => {
                                const amount = Math.ceil(
                                  quote.proposedAmount / parseInt(months),
                                );
                                return (
                                  <label
                                    key={months}
                                  ...
                                  >
                                    ...
                                    <div
                                      className={`p-3 rounded-lg border text-center transition-all ${
                                        acceptanceData.installmentPlan ===
                                        months
                                          ? "border-klusdirect-orange bg-klusdirect-orange/10"
                                          : "border-premium-600/30 hover:border-premium-500/50"
                                      }`}
                                    >
                                      <div className="font-semibold text-premium-50">
                                        {months} maanden
                                      </div>
                                      <div className="text-sm text-premium-300">
                                        €{amount}/maand
                                      </div>
                                    </div>
                                  </label>
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    >
                      ...
                      en de offerte van {quote.craftsmanName}.{" "}
                  ...
                  <Card className="glass border border-klusdirect-blue/30 bg-klusdirect-blue/5">
                    ...
                    <CardContent>
                      <div className="space-y-2">
                        {calculateInstallments().schedule.map(
                          (installment, index) => (
                            <div
                              key={index}
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <Label
                      ...
                      className="text-premium-200 text-sm cursor-pointer"
                    >
                      Ik ga akkoord met het delen van mijn contactgegevens met{" "}
                      {quote.craftsmanName} voor de uitvoering van deze klus.
                      <span className="text-red-400 font-semibold"> *</span>
                    </Label>
                  </div>
                </div>
          ...
          <div className="py-8 text-center">
            ...
            <p className="text-premium-200 mb-6 text-lg">
              {quote.craftsmanName} ontvangt een bevestiging en neemt binnen 24
              uur contact met u op.
            </p>
            ...
            <div className="bg-premium-700/50 rounded-lg p-6 mb-6 text-left max-w-md mx-auto">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-premium-200">
                    Vakman plant de werkzaamheden in
                  </span>
                </div>
                <div className="flex items-center">
                  <div className="w-6 h-6 bg-klusdirect-orange rounded-full flex items-center justify-center mr-3">
