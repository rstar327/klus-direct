  ...
  const features = [
    {
      ...
      description:
        "Premium geverifieerde vakmensen met de hoogste kwaliteitsstandaarden",
    },
    {
      icon: MapPin,
  ...
  const services = [
    {
      ...
      name: "Loodgieter",
      color:
        "bg-gradient-to-br from-klusdirect-blue/20 to-klusdirect-blue/10 text-klusdirect-blue border border-klusdirect-blue/20",
    },
    {
      icon: Home,
      name: "Dakdekker",
      color:
        "bg-gradient-to-br from-emerald-500/20 to-emerald-500/10 text-emerald-400 border border-emerald-500/20",
    },
    {
      icon: Zap,
      name: "Elektricien",
    ...
    },
    {
      ...
      name: "Timmerman",
      color:
        "bg-gradient-to-br from-klusdirect-orange/20 to-klusdirect-orange/10 text-klusdirect-orange border border-klusdirect-orange/20",
    },
    {
      icon: Users,
      name: "Schilder",
      color:
        "bg-gradient-to-br from-purple-500/20 to-purple-500/10 text-purple-400 border border-purple-500/20",
    },
  ];
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-20 animate-fade-in">
            ...
            <p className="text-xl text-premium-200 mb-12 max-w-3xl mx-auto">
              Het premium platform dat topklanten verbindt met de beste
              vakmensen van Nederland. Luxe service, perfecte kwaliteit, altijd.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-24 max-w-5xl mx-auto">
            <Card className="group glass border-2 border-premium-600/30 hover:border-klusdirect-blue/50 transition-all duration-500 transform hover:-translate-y-2 hover:shadow-2xl relative overflow-hidden">
              ...
              <CardHeader className="text-center pb-6 relative z-10">
                ...
                <p className="text-klusdirect-blue text-sm font-medium">
                  PREMIUM CLIENT
                </p>
              </CardHeader>
              <CardContent className="text-center relative z-10">
                <p className="text-premium-200 mb-8 text-lg">
                  Toegang tot onze elite vakmannen met gegarandeerde kwaliteit
                  en premium service.
                </p>
                ...
                <Link to="/customer/register">
                  <Button
                    size="lg"
                    className="w-full bg-gradient-to-r from-klusdirect-blue to-klusdirect-blue-dark hover:from-klusdirect-blue-dark hover:to-klusdirect-blue text-white group-hover:scale-105 transition-transform duration-300 text-lg py-6"
                  >
            ...
            <Card className="group glass border-2 border-premium-600/30 hover:border-klusdirect-orange/50 transition-all duration-500 transform hover:-translate-y-2 hover:shadow-2xl relative overflow-hidden">
              ...
              <CardHeader className="text-center pb-6 relative z-10">
                ...
                <p className="text-klusdirect-orange text-sm font-medium">
                  ELITE PARTNER
                </p>
              </CardHeader>
              <CardContent className="text-center relative z-10">
                <p className="text-premium-200 mb-8 text-lg">
                  Word onderdeel van ons exclusieve netwerk en vind premium
                  klanten.
                </p>
                <ul className="space-y-4 mb-10 text-left">
                  <li className="flex items-center text-premium-100">
                ...
                <Link to="/craftsman/register">
                  <Button
                    size="lg"
                    className="w-full bg-gradient-to-r from-klusdirect-orange to-klusdirect-gold hover:from-klusdirect-gold hover:to-klusdirect-orange text-black group-hover:scale-105 transition-transform duration-300 text-lg py-6 font-semibold"
                  >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-24">
            {stats.map((stat, index) => (
              <div
                key={index}
                className="text-center animate-fade-in glass rounded-xl p-6 border border-premium-600/30"
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {services.map((service, index) => (
              ...
              >
                <div
                  className={`w-18 h-18 rounded-2xl ${service.color} flex items-center justify-center mx-auto mb-4 group-hover:shadow-lg group-hover:shadow-klusdirect-gold/20 transition-all duration-300`}
                >
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <Card
                key={index}
                className="text-center glass border border-premium-600/30 hover:border-klusdirect-gold/30 hover:shadow-lg hover:shadow-klusdirect-gold/10 transition-all duration-300 animate-fade-in"
                style={{ animationDelay: `${index * 0.1}s` }}
              >
                <CardContent className="pt-8">
                  ...
                  <p className="text-premium-300">{feature.description}</p>
                </CardContent>
              </Card>
            ))}
          </div>
      ...
      <section className="relative z-10 py-20 bg-gradient-to-r from-premium-800 to-premium-700 border-y border-premium-600/50">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-premium-200 mb-10 max-w-2xl mx-auto">
            Ervaar het verschil van premium kwaliteit. Word onderdeel van
            Nederland's meest exclusieve platform.
          </p>
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Link to="/customer/register">
              <Button
                size="lg"
                className="bg-gradient-to-r from-klusdirect-blue to-klusdirect-blue-dark hover:from-klusdirect-blue-dark hover:to-klusdirect-blue text-white px-8 py-4 text-lg"
              >
                <Crown className="w-5 h-5 mr-2" />
            ...
            <Link to="/craftsman/register">
              <Button
                size="lg"
                className="bg-gradient-to-r from-klusdirect-orange to-klusdirect-gold hover:from-klusdirect-gold hover:to-klusdirect-orange text-black px-8 py-4 text-lg font-semibold"
              >
                <Sparkles className="w-5 h-5 mr-2" />
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            <div>
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  <h4 className="text-2xl font-bold text-premium-gradient">
                    KlusDirect
                  </h4>
                  <div className="flex items-center space-x-1">
                    <Crown className="w-3 h-3 text-klusdirect-gold" />
              ...
              <p className="text-premium-300 mb-6">
                Het meest exclusieve platform voor premium vakmensen en elite
                klanten in Nederland.
              </p>
            </div>

            <div>
              <h5 className="font-semibold mb-4 text-premium-50">
                Premium Clients
              </h5>
              <ul className="space-y-2 text-premium-300">
                <li>
                  <a
                    href="#"
                    className="hover:text-klusdirect-gold transition-colors"
                  >
                    Luxury Projects
                  </a>
                </li>
