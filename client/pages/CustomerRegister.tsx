                ...
                <div className="flex items-center space-x-4">
                  <div
                    className={`flex items-center justify-center w-8 h-8 rounded-full border-2 ${
                      step >= 1
                        ? "bg-klusdirect-blue border-klusdirect-blue text-white"
                  ...
                  <div
                    className={`w-12 h-1 ${step > 1 ? "bg-klusdirect-blue" : "bg-premium-700"}`}
                  ></div>
                  <div
                    className={`flex items-center justify-center w-8 h-8 rounded-full border-2 ${
                      step >= 2
                  ...
                  <div
                    className={`w-12 h-1 ${step > 2 ? "bg-klusdirect-blue" : "bg-premium-700"}`}
                  ></div>
                  <div
                    className={`flex items-center justify-center w-8 h-8 rounded-full border-2 ${
                      step >= 3
              ...
              {step === 1 && (
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <Label htmlFor="dateOfBirth" className="text-premium-200">
                        Geboortedatum
                      </Label>
                      <div className="relative mt-1">
              ...
              {step === 2 && (
                <div className="space-y-6">
                  <div className="text-center">
                    ...
                    <p className="text-premium-300">
                      Voor facturering en het plaatsen van klussen op
                  ...
                  <div className="space-y-6">
                    {/* Address Information */}
                    <div>
                      <h4 className="text-lg font-medium text-premium-50 mb-3">
                        Adresgegevens
                      </h4>
                      <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          <div>
                            <Label htmlFor="city" className="text-premium-200">
                              Plaats *
                            </Label>
                            <Input
                              id="city"
              ...
              {step === 3 && (
                <div className="space-y-6">
                  <div className="text-center">
                    ...
                    <p className="text-premium-300">
                      Stel uw communicatievoorkeuren in en ga akkoord met onze
                      voorwaarden
                    </p>
                  </div>
                        ...
                        <div className="space-y-2">
                          <label className="flex items-center space-x-3 cursor-pointer p-3 rounded-lg border border-premium-600/30 hover:border-premium-500/50">
                            <RadioGroupItem
                              value="email"
                              id="comm-email"
                              className="border-premium-600 text-klusdirect-blue"
                            />
                          ...
                          <label className="flex items-center space-x-3 cursor-pointer p-3 rounded-lg border border-premium-600/30 hover:border-premium-500/50">
                            ...
                            <div>
                              ...
                              <p className="text-premium-400 text-sm">
                                Ontvang push notificaties in de app
                              </p>
                            </div>
                          </label>
                        </div>
                    ...
                    <div className="space-y-4 pt-4 border-t border-premium-600/30">
                      <div className="flex items-start space-x-3">
                        <Checkbox
                          ...
                          onCheckedChange={(checked) =>
                            handleInputChange("termsConsent", checked)
                          }
                          className="border-premium-600 data-[state=checked]:bg-klusdirect-blue data-[state=checked]:border-klusdirect-blue"
                        />
                        <Label
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        >
                          ...
                          en geef toestemming voor de verwerking van mijn
                          gegevens.{" "}
                          <span className="text-red-400 font-semibold"> *</span>
                        </Label>
                      </div>
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <Label
                          ...
                          className="text-premium-200 text-sm cursor-pointer"
                        >
                          Ik wil updates ontvangen over nieuwe features,
                          aanbiedingen en premium services
                        </Label>
                      </div>
                    </div>
